...
\begin{question}
  ...
  (Para simplificar os cálculos \emph{apenas neste exemplo},
  ignore o fato desse vetor não ser unitário)
\end{question}
...
\begin{resolution}{Solução}
  \begin{align*}
    \onslide<+->{D_u f(1, 2)}
    \onslide<+->{& = \lim_{h\to 0} \frac{f(a+hu_1, b+hu_2)-f(a, b)}{h} \evalat{(a, b)=(1, 2)}{}\\}
