...
\begin{frame}{Derivada de uma Função Real}
  ...
  \pause
  é a função $f'$ cujo valor em $x$
  \pause
  é
  \[
    f'({\color<5->{magenta}x})
    = \lim_{{\color<4->{blue}h}\to 0}
    \frac{\,f({\color<5->{magenta}x}+{\color<4->{blue}h})-f({\color<5->{magenta}x})\,}
         {{\color<4->{blue}h}}
  \]
  \onslide<6->{desde que o limite exista}
\end{frame}
...
%------------------------------------------------------------------------------%
\begin{frame}{Derivadas de Algumas Funções}
\begin{columns}
...
\begin{frame}{Lista Mínima}
  ...
  \begin{enumerate}
    \item Revisar atentamente texto do Capítulo 3
  \end{enumerate}
  \vfill
