...
\begin{enumerate}
    ...
    \item Identificar o resultado: número finito, $\infty$, $-\infty$
          ou indeterminação
    ...
    \end{itemize}
    \item Repetir até obter valor definido
\end{enumerate}
\end{frame}
...
%------------------------------------------------------------------------------%
\include{A-04-Limites-ex1}
\include{A-04-Limites-ex2}
\include{A-04-Limites-ex3}
\include{A-04-Limites-ex4}
\include{A-04-Limites-ex5}
