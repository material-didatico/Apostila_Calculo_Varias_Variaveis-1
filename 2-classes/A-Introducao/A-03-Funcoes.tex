...
\begin{frame}{Função}
  ...
  \emph{um único} elemento $y$ do \emph{contradomínio}, $C$
...
\begin{frame}{Funções Exponencial e Logarítmica}
  ...
  \onslide<+->{
  \begin{align*}
    y & = \log_b(x) & \quad\Rightarrow\qquad b^y = x & \hspace{90mm}~\\
...
\begin{frame}{Lista Mínima}
  ...
  \begin{enumerate}
    \item Revisar atentamente texto do Capítulo 1
  \end{enumerate}
  \vfill
