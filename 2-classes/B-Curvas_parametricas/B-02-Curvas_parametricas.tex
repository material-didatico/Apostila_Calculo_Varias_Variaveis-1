...
\begin{frame}{Notações}
  Depende do contexto e da área do conhecimento
...
\include{ex/B-02-Curvas_parametricas-ex1}
\include{ex/B-02-Curvas_parametricas-ex2}
\include{ex/B-02-Curvas_parametricas-ex3}
\include{ex/B-02-Curvas_parametricas-ex4}
\include{ex/B-02-Curvas_parametricas-ex5}
\include{ex/B-02-Curvas_parametricas-ex6}
\include{ex/B-02-Curvas_parametricas-ex7}
\include{ex/B-02-Curvas_parametricas-ex8}
\include{ex/B-02-Curvas_parametricas-ex9}
