...
\column{0.5\linewidth}
  ...
  ou
  \begin{align*}
    \onslide<+->{y\neq 0\quad\text{e}\quad\lambda^2     & = 4  \\}
...
\column{0.2\linewidth}
  ...
  \begin{align*}
    \onslide<+->{x^2 + 4y^2    & = 8     \\[-1mm]}
    \onslide<+->{(2x)^2 + 4y^2 & = 8     \\[-1mm]}
    \onslide<+->{4y^2 + 4y^2   & = 8     \\[-1mm]}
    \onslide<+->{8y^2          & = 8     \\[-1mm]}
    \onslide<+->{y^2           & = 1     \\[-1mm]}
    \onslide<+->{y             & = \pm 1}
  \end{align*}
\column{0.45\linewidth}
  \vspace{-2\baselineskip}
  \begin{align*}
    \onslide<+->{\qquad\text{Se } y & = 1        \\[-1mm]}
    \onslide<+->{x            & = 2y}
    \onslide<+->{               \;=\; 2    \\[-1mm]}
    \onslide<+->{P_1          & = ( 2,  1) \\[3mm]}
    \onslide<+->{\text{Se } y & = -1       \\[-1mm]}
    \onslide<+->{x            & = 2y}
    \onslide<+->{               \;=\; -2   \\[-1mm]}
    \onslide<+->{P_2          & = (-2,  1)}
  \end{align*}
