...
\begin{resolution}{Pontos críticos}
  ...
  Buscamos os pontos onde as derivadas parciais são nulas
\end{resolution}
...
%------------------------------------------------------------------------------%
\begin{resolution}{Analisando o ponto $(0, 0)$}
  Como
  \[
    \pause
    D(0, 0)
...
%------------------------------------------------------------------------------%
\begin{resolution}{Analisando o ponto $(2, 2)$}
  \onslide<+->{Como}
  \[
    \onslide<+->{D(2, 2)}
    \onslide<+->{= 72(2-1)}
    ...
    \onslide<+->{< 0}
  \]
  \onslide<+->{pelo teste da derivada segunda,}
