...
\begin{resolution}{Pontos críticos interiores}
  ...
  \vspace{0.5\baselineskip}
  \onslide<+->{O ponto $(1, 1)$ está no interior da região $R$}
\end{resolution}
...
\begin{resolution}{Valores da função}
  Ponto crítico e fronteira do intervalo \(x=0\), \(x=1\) e \(x=9\)
...
%------------------------------------------------------------------------------%
\begin{resolution}{Valores da função}
  Ponto crítico e fronteira do intervalo \(y=0\), \(y=0\) e \(y=9\)
...
\begin{resolution}{Solução}
  Ponto crítico e fronteira do intervalo \(x=0\), \(x=\frac{9}{2}\) e \(x=9\)
