...
%------------------------------------------------------------------------------%
\include{G-01-Regra-da-cadeia-ex1}
...
%------------------------------------------------------------------------------%
\framedgraphic{Regra da Cadeia -- Caso 1}{diagrama-caso-1-3}{}
...
\begin{frame}{Regra da Cadeia -- Caso 2}
  \centering
  \includegraphics[page=1]{diagrama-caso-2}
  \hspace{15mm}
  \includegraphics[page=2]{diagrama-caso-2}
\end{frame}
