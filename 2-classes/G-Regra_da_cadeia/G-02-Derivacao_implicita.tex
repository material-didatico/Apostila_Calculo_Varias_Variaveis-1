...
\begin{frame}{Derivação Implícita}
  Suponha que $F(x, y)$ seja diferenciável e a equação
  \[
    F(x, y) = 0
  \]
...
\begin{frame}{Derivação Implícita -- Três Variáveis}
  Suponha que $F(x, y, z)$ seja diferenciável e a equação
  \[
    F(x, y, z) = 0
  \]
...
%------------------------------------------------------------------------------%
\include{ex/G-02-Derivacao_implicita-ex2}

%------------------------------------------------------------------------------%
\section{Exemplos}

\include{ex/G-02-Derivacao_implicita-ex3}
\include{ex/G-02-Derivacao_implicita-ex4}
