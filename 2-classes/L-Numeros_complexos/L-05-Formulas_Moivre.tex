...
%------------------------------------------------------------------------------%
\begin{warningframe}{Funções Raiz}
  Atenção: \emph{Não definimos as funções raiz}

  \pause
  \bigskip
  Para definir uma função raiz precisamos determinar como \\
  escolher consistentemente \emph{uma única} resposta

  \pause
  \bigskip
  \textbf{\textcolor{red}{NÃO USE A NOTAÇÃO} }
  \Large \;
  \(
    \sqrt[n]{z\,}
  \)
