...
\include{ex/E-02-Inexistencia-ex1}
...
\begin{frame}{Teste dos Dois Caminhos}
  ...
  então
  \[
    \lim_{(x, y)\to(a, b)} f(x, y) \quad \text{ \emph{não existe}}
  \]
\end{frame}
...
\include{ex/E-02-Inexistencia-ex2}
\include{ex/E-02-Inexistencia-ex3}
\include{ex/E-02-Inexistencia-ex4}
\include{ex/E-02-Inexistencia-ex5}
