...
\exercise{50\%}
  ...
  \begin{gather*}
    x(t) = 3 \cos\left(t^2\right) +1 \\
    y(t) = 3 \sin\left(t^2\right) +3 \\
    0 \leq t \leq \sqrt{\pi}
  \end{gather*}
...
\end{questiononly}
\begin{answeronly}
  \hfill\includegraphics{T3_A_parametrica}
\end{answeronly}
\end{multicols}
\textit{
...
\begin{enumerate}[label=(\alph*),itemsep=0pt]
  ...
  \item \ [10\%] determine a curva de nível que passa pelo ponto \((1, 0)\)
  \item \ [10\%] esboce a curva de nível que passa pelo ponto \((1, 0)\)
\end{enumerate}
\begin{questiononly}
  \begin{multicols}{2}
    \;\; Domínio
...
\begin{answeronly}
  \begin{multicols}{2}
    ...
    \vspace{-0.3\baselineskip}
    \begin{center}
      \includegraphics{T3_A_dominio}
    \end{center}
    \;\; Curva de nível
    \vspace{-0.3\baselineskip}
    \begin{center}
      \includegraphics{T3_A_curva_nivel}
    \end{center}
  \end{multicols}
\end{answeronly}
...
\begin{answer}
  ...
  \bigskip
  \textbf{c)} \quad
  A curva de nível que passa pelo ponto $(1, 0)$ tem o valor
  \[
    c
    = f(1, 0)
    = \ln\left(9 -x^2 +y^2 \right) \evalat{(1, 0)}{}
    = \ln\left(9 -1^2 +0^2 \right)
    = \ln 8
  \]
