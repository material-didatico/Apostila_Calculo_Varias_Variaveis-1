...
\begin{frame}{Atenção Para a Ordem das Derivadas Mistas}
  \[
    \frac{\partial^2 f}{\partial x \partial \emph{y}}
    = \frac{\partial}{\partial x}
      \left(\,\frac{\partial f}{\partial \emph{y}}\,\right)
  \]

  \vspace{\baselineskip}
  \[
    f_{\emph{x}y} = \big(\,f_\emph{x}\,\big)_y
  \]
\end{frame}
...
%------------------------------------------------------------------------------%
\begin{frame}[t]{Exemplo \theexemplo \; -- \qquad $f_x$}
\begin{align*}
  \onslide<+->{f_x(x, y)}
  \onslide<+->{& = \D{f}{x} \\[2mm]}
...
%------------------------------------------------------------------------------%
\begin{frame}[t]{Exemplo \theexemplo \; -- \qquad $f_y$}
\begin{align*}
  \onslide<+->{f_y(x, y)}
  \onslide<+->{& = \D{f}{y} \\[2mm]}
...
%------------------------------------------------------------------------------%
\begin{frame}[t]{Exemplo \theexemplo \; -- \qquad $f_{xx}$}
\begin{align*}
  \onslide<+->{f_{xx}(x, y)}
  \onslide<+->{& = \DS{f}{x} \\[2mm]}
...
%------------------------------------------------------------------------------%
\begin{frame}[t]{Exemplo \theexemplo \; -- \qquad $f_{xy}$}
\begin{align*}
  \onslide<+->{f_{xy}(x, y)}
...
%------------------------------------------------------------------------------%
\begin{frame}[t]{Exemplo \theexemplo \; -- \qquad $f_{yy}$}
\begin{align*}
  \onslide<+->{f_{yy}(x, y)}
  \onslide<+->{& = \DS{f}{y} \\[2mm]}
...
%------------------------------------------------------------------------------%
\begin{frame}[t]{Exemplo \theexemplo \; -- \qquad $f_{yx}$}
\begin{align*}
  \onslide<+->{f_{yx}(x, y) }
