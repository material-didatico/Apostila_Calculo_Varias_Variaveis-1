...
\begin{frame}{Diferenciabilidade em 1D}
	...
	Existe uma \emph{reta tangente} a $f$ no ponto \(\big(x_0, f(x_0)\big)\)
  ...
  \[
    \pause
    \hphantom{\Delta y} = f'(x_0)\Delta x + \emph{\varepsilon \Delta x}
  \]
  \[
    \pause
...
\begin{frame}{Definição -- Derivada Parcial em $x$}
  ...
  \[
    ...
    =\; \lim_{h\to 0} \frac{f(\emph{x_0+h}, y_0)-f(\emph{x_0}, y_0)}{h}
  \]
...
\begin{frame}{Teorema do Incremento}
  ...
  \pause
	e que \emph{$f_x$ e $f_y$ sejam contínuas em $(x_0, y_0)$},
	\pause
	então a variação
	\[
		\pause
