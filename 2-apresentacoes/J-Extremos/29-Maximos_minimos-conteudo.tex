...
\begin{frame}{Ponto Crítico}
  Um ponto $(a, b)$ no interior do domínio de uma função \(f(x, y)\) onde
  ...
  \pause
  \vspace{0.1\baselineskip}
  ou \(f_x(a, b)\) ou \(f_y(a, b)\) não exista
...
%------------------------------------------------------------------------------%
\include{29-Maximos_minimos-conteudo-ex1}
...
%------------------------------------------------------------------------------%
\include{29-Maximos_minimos-conteudo-ex2}
\include{29-Maximos_minimos-conteudo-ex3}
\include{29-Maximos_minimos-conteudo-ex4}
\include{29-Maximos_minimos-conteudo-ex5}
\include{29-Maximos_minimos-conteudo-ex6}
\include{29-Maximos_minimos-conteudo-ex7}
\include{29-Maximos_minimos-conteudo-ex8}
\include{29-Maximos_minimos-conteudo-ex9}
